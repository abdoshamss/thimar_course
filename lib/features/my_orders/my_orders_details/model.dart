...
class MyOrdersDetailsModel {
  ...
  get stringOrderPrice => orderPrice.toString().replaceAll(".0", "");
  get stringPriceBeforeDiscount => priceBeforeDiscount.toString().replaceAll(".0", "");
  get stringDiscount => discount.toString().replaceAll(".0", "");
  get stringVipDiscount => vipDiscount.toString().replaceAll(".0", "");
  get stringDeliveryPrice => deliveryPrice.toString().replaceAll(".0", "");
  get stringTotalPrice => totalPrice.toString().replaceAll(".0", "");
