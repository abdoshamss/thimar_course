...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/edit_address.png
  ...
  /// File path: assets/icons/person_home.png
  AssetGenImage get personHome =>
      const AssetGenImage('assets/icons/person_home.png');
  ...
  /// File path: assets/icons/rank.png
  AssetGenImage get rank => const AssetGenImage('assets/icons/rank.png');
